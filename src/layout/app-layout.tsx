...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'marketing-manager', 'social-media-specialist'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Post', path: '/posts', entity: 'post', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
